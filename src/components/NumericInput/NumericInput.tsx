    ...
    return (
        ...
        >
            ...
            <button
                ...
                className="bg-bgColor-primary hover:bg-bgColor-primary-hover text-textColor border-borderColor-primary hover:border-borderColor-hover border rounded-r b w-10 cursor-pointer outline-none"
                onClick={() => props.onChange(formatNumber((props.value ?? 0) + 1))}
            >
                <span className="m-auto text-1xl font-thin">+</span>
            </button>
